...
class IonAuth extends \IonAuth\Config\IonAuth
{
	 ...
	 */
    public $general_settings, $email_settings;
    public $siteTitle;       // Site Title, example.com
    public $adminEmail; // Admin Email, admin@example.com
    public $emailActivation;
    public function __construct()
    {
        parent::__construct();
        helper('function');
        $this->general_settings =  get_settings('general_settings', true);
        $this->email_settings =  get_settings('email_settings', true);

        /* dynamic email site name */
        $this->siteTitle = (isset($this->general_settings['company_title']) && !empty($this->general_settings['company_title'])) ? $this->general_settings['company_title'] : "eSpeech - TTS";       // Site Title, example.com

        /* dynamic email from address */
        $this->adminEmail = (isset($this->email_settings['smtpUsername']) && !empty($this->email_settings['smtpUsername'])) ? $this->email_settings['smtpUsername'] : "youremail@gmail.com"; // Admin Email, admin@example.com

        /* dynamic email activation option setting */
        $this->emailActivation = (isset($this->general_settings['activate_registration']) && !empty($this->general_settings['activate_registration'])) ? $this->general_settings['activate_registration'] : false;               // Email Activation for registration
    }
    //TODO: have need to intigrate custom template for sending email!
