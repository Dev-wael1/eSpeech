...
class Paytm
{
    ...
    static public function initiate_transaction($params)
    {
        ...
        /* for Staging */
        if ($credentials['paytm_mode'] == "test") {
            $url = "https://securegw-stage.paytm.in/theia/api/v1/initiateTransaction?mid=" . $credentials['paytm_merchant_id'] . "&orderId=" . $params['body']['orderId'];
        } else {
             $url = "https://securegw.paytm.in/theia/api/v1/initiateTransaction?mid=" . $credentials['paytm_merchant_id'] . "&orderId=" . $params['body']['orderId'];
        }
