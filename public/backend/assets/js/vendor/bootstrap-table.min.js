...
!(function (t, e) {
        ...
        [
          ...
          function (t, o) {
            ...
            for (var f = 0, p = 0, g = []; p < r.length; ) {
              u.lastIndex = Me ? p : 0;
              var v,
                b = Ve(u, Me ? r : r.slice(p));
              if (
                null === b ||
                (v = Le(wt(u.lastIndex + (Me ? 0 : p)), r.length)) === f
              )
                p = De(r, p, c);
              else {
  ...
  var Ue,
    ...
    qe = b
      ...
      : function (t, e) {
          V(t);
          for (var i, n = ze(e), o = n.length, a = 0; o > a; )
            L.f(t, (i = n[a++]), e[i]);
          return t;
        },
    We = gt("document", "documentElement"),
    Ge = nt("IE_PROTO"),
    Ke = function () {},
    Ye = function (t) {
  ...
  var ii =
    ...
    si = function (t, e) {
      ...
      return (
        ii(t) &&
          ...
          (i !== Array && !ii(i.prototype))
            ? I(i) && null === (i = i[ai]) && (i = void 0)
            : (i = void 0)),
    ...
    ci = ke("isConcatSpreadable"),
    hi = 9007199254740991,
    ui = "Maximum allowed index exceeded",
    di =
      be >= 51 ||
      !v(function () {
        var t = [];
  ...
  Mt(
    { target: "Array", proto: !0, forced: !di || !fi },
    {
      concat: function (t) {
        var e,
          i,
  ...
  Mt(
    { target: "String", proto: !0, forced: !ki("includes") },
    {
      includes: function (t) {
  ...
  var ji = w.f,
    _i = function (t) {
      return function (e) {
        for (var i, n = P(e), o = ze(n), a = o.length, s = 0, r = []; a > s; )
          (i = o[s++]), (b && !ji.call(n, i)) || r.push(t ? [i, n[i]] : n[i]);
        return r;
      };
    },
  ...
  var Qi = Object.assign,
    ...
    tn =
      ...
      v(function () {
        ...
        ? function (t, e) {
            for (
              var i = ni(t), n = arguments.length, o = 1, a = Et.f, s = w.f;
              n > o;
    ...
    { target: "Array", proto: !0, forced: !Co },
    {
      splice: function (t, e) {
        ...
        if (
          ...
          throw TypeError(Ao);
        for (o = si(l, n), a = 0; a < n; a++)
          (s = h + a) in l && oi(o, a, l[s]);
        if (((o.length = n), i < n)) {
          for (a = h; a < c - n; a++)
            ...
            value: function () {
              ...
              if (
                ...
                var e =
                  ...
                  i = ua.isEmptyObject(this.filterColumns)
                    ? null
                    : this.filterColumns;
                this.options.searchAccentNeutralise &&
                  (e = ua.normalizeAccent(e)),
                  ...
                  ? this.data.filter(function (i, o) {
                      for (var a = 0; a < t.header.fields.length; a++)
                        if (
                          ...
                          var s = ua.isNumeric(t.header.fields[a])
