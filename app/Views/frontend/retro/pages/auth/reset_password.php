    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-center">
            <div class="text-white p-1 p-md-5 mx-md-4 h-75">
                <lottie-player
                    src="<?=base_url('public/frontend/retro/img/lottieImages/forget-password.json')?>"
        ...
        <div class="col-lg-6">
            <div class="p-md-5 mx-md-4">
                ...
                <div class="alert alert-warning" role="alert">
                    Use at least 8 characters while creating a password
                </div>
                <?php echo form_open('auth/reset_password/' . $code); ?>
                <div class="form-outline mb-4 input-group">
                    <label for="new_password"
                        class="d-none"><?php echo sprintf(lang('Auth.reset_password_new_password_label'), $minPasswordLength); ?></label>
                ...
                <div class="text-center form-outline mb-4 pb-1">
                    <p><?php echo form_submit('submit', lang('Auth.reset_password_submit_btn'), "class='mb-2 btn btn-buy width-11'"); ?>
                    </p>
                </div>
                <?php echo form_close(); ?>
            </div>
