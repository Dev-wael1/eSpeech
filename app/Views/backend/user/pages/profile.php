                        ...
                        <form action="<?= base_url('user/update-profile') ?>" id="update_user_profile" method="post" accept-charset="utf-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row ">
                                    <div class="avatar-item col-md-3">
                                        ...
                                        ?>
                                            ...
                                            <a href="<?= base_url('public/backend/assets/profiles/' . $data['image'])  ?>" data-lightbox="image-1"><img height="100px" src="<?= base_url('public/backend/assets/profiles/' . $data['image'])  ?>" alt=""></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        <label><?= labels('confirm_password', "Confirm Password") ?> ( <?= labels('leave_blank', "Leave it blank to disable it") ?> )</label>
                            ...
                            <div class="card-footer text-right">
                                <a href="<?= base_url('user/dashboard') ?>" class="btn btn-primary"><?= labels('cancel', "Cancel") ?></a>
